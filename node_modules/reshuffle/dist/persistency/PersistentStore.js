...
var PersistentStore = /** @class */ (function () {
    function PersistentStore(backend, prefix) {
    ...
    PersistentStore.prototype.del = function (key) {
    ...
    PersistentStore.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            var array;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.adapter.list()];
                    case 1:
                        array = _a.sent();
                        return [2 /*return*/, array.filter(function (key) { return key.startsWith(_this.prefix); })];
                }
            });
        });
    };
    ...
    PersistentStore.prototype.update = function (key, updater) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.validateKey(key);
                return [2 /*return*/, this.adapter.update(this.prefix + key, updater)];
            });
        });
    };
    PersistentStore.prototype.validateKey = function (key) {
        if (typeof key !== 'string' || key.length === 0) {
            throw new Error("PersistentStore: Invalid key: " + key);
        }
    };
    PersistentStore.prototype.validateValue = function (value) {
        if (value === undefined) {
